...
<p class="tagline">Город, который однажды решил, что мыслить — не обязательно.</p>
...
<p class="support-note">[контактная форма / email — добавить]</p>

## Об авторе

<p class="muted">[короткая авторская справка — добавить]</p>

</div>

<div class="lang-en" markdown="1">

<p class="tagline">A city that once decided thinking is no longer required.</p>
...
<p class="support-note">[contact form / email — to be added]</p>

## About the Author

<p class="muted">[short author bio — to be added]</p>

</div>

<p class="wip">Страница в разработке. Civitas Lucida — рабочее название романа и проекта, которые сейчас создаются. / Page under construction. Civitas Lucida is a working title for the novel and project currently in development.</p>
